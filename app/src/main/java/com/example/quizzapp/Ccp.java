...
public class Ccp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cd=new CountDownTimer(10000,1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent(Ccp.this,Cptimer.class);
        ...
        database.collection("Categories").document("c++").collection("questions").orderBy("index")
